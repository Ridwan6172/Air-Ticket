...
<center><img src='images/Screenshot (77).png' class='img-thumbnail' width='1200px' style='height:130px;'></center>";
  ...
  <div class="container-fluid">
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <center><font style="font-family:Verdana; font-size:18px;">
                   Airport Authority Of Bangladesh<br>
                   ...
                   <?php
                    ...
                    while($row1 = mysqli_fetch_array($result1))
                      {                  
                        ...
                        echo "<center><img src='images/Screenshot (77).png' class='img-thumbnail' width='180px' style='height:180px;'></center>";
                        echo"<div>";
                      }
                   ?>
                        </td>
